...
resource "azurerm_linux_web_app_slot" "app_service_slots_linux" {
  ...
  client_certificate_exclusion_paths = lookup(each.value, "client_certificate_exclusion_paths", var.client_certificate_exclusion_paths)
  ...
  site_config {
    ...
    application_insights_connection_string        = lookup(lookup(each.value, "site_config", {}), "application_insights_connection_string", lookup(var.site_config, "application_insights_connection_string", null))
    application_insights_key                      = lookup(lookup(each.value, "site_config", {}), "application_insights_key", lookup(var.site_config, "application_insights_key", null))
